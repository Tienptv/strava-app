    ...
    try:
        ...
        while True:
            ...
            for item in data:
                ...
                # Check for green shirt (g > r + 30 and g > b + 30 and g > 60)
                elif g > r + 20 and g > b + 20 and g > 60:
                    # Map to Cyan (0, 150, 170)
                    factor = g / 255.0
                    new_data.append((0, int(150 * factor), int(170 * factor), a))
                    
                # Check for blue pants (b > r + 30 and b > g + 10 and b > 50)
                elif b > r + 30 and b > g + 10 and b > 50:
                    # Map to Lime Green (140, 200, 50)
                    factor = b / 255.0
                    new_data.append((int(140 * factor), int(200 * factor), int(50 * factor), a))
                else:
