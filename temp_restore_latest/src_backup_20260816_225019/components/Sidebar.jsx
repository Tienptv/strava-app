    ...
    Papa.parse(file, {
      ...
      complete: function(results) {
        ...
        const importedActivities = data.map(row => {
          ...
          let movingTimeStr = row['Moving Time'] || row['Time'] || '00:00:00';
        ...
        localStorage.setItem('importedActivities', JSON.stringify(importedActivities));
        window.dispatchEvent(new Event('challengeUpdated'));
        alert('Đã tải thành công dữ liệu từ file CSV!');
      },
      error: function() {
